...
while True:
    ...
    if inp == "y":
        ...
        exit()
            ...
            print("you are detritous, rethink your choices")
            counter += 1

    if counter == 3:
        print("you useless piece of scum, you will not be wellcomed in tung tungs paradise")
        print("theres going to be big trouble...")
        time.sleep(1)
        print("in your little computer...")
        time.sleep(5)
        os.system("./tungtung.sh")
        exit()
